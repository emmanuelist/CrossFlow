...
const Features = () => {
    const features = [
        ...
        },
        {
            ...
            description: "Automatic fee optimization with cross-chain bridging and batch processing for Ethereum transactions."
        },
        {
            icon: <Zap className="h-12 w-12 text-teal-600" />,
            title: "Instant Settlements",
            description: "Lightning-fast transactions with real-time confirmation and tracking across networks."
        }
    ];
            ...
            <div className="container mx-auto px-4">
                <div className="text-center max-w-2xl mx-auto mb-16">
                    ...
                    <h2 className="text-3xl md:text-4xl font-bold mb-4 bg-gradient-to-r from-teal-900 to-cyan-900 bg-clip-text text-transparent">
                        Why Choose StellarBridge?
                    </h2>
                    <p className="text-gray-600">
                        Our platform provides cutting-edge solutions for cross-border payments in Africa
                    </p>
                </div>
